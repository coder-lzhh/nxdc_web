<template>
	<view class="container">
		<view class="banner">
			...
			<view class="intro">
				<view class="greet">您好，{{ TokenKey ? (member.nikeName ? member.nikeName : member.userPhone) : '游客' }}</view>
				<view class="note">一杯奶茶，一口软欧包，在奈思遇见两种美好</view>
			</view>
		</view>
		<view class="content">
			<view class="entrance">
			...
			<view class="info">
				<view class="integral_section" @tap="integrals">
					<view class="top">
						...
						<text class="value">{{ TokenKey ? member.consum : '**' }}</text>
					</view>
					<view class="bottom">
						进入积分商城兑换奈思券及周边好礼
				...
				<view class="left">
					<view class="grid flex-column just-content-center">
						<view class="d-flex align-items-center">
							...
							<view class="font-size-sm text-color-base">奈思的茶商城</view>
						</view>
